  ...
  function ConsumerWrapper(props) {
    ...
    _this.ctxInfo = {
      ...
      onUpdate: function onUpdate(updator) {
        _this.updateListener.set(updator, updator); // 返回更新监听器的注销方法
...
var fixedContextSnapshot = {}; // 对 ConsumerWrapper 的递归结构，会在 devtool 中生成较深的嵌套结构，可用 hooks 消除嵌套结构
...
var ErrorBoundaryBridge = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ErrorBoundaryBridge, [{
    ...
    value: // Error Boundary 透传至对应 KeepAlive 实例位置
    ...
    _defineProperty(_assertThisInitialized(_this), "drop", function () {
      ...
      return new Promise(function (resolve) {
        ...
        var drop = function drop() {
          ...
          _this.eventBus.off(LIFECYCLE_UNACTIVATE, drop); // 用在多层 KeepAlive 同时触发 drop 时，避免触发深层 KeepAlive 节点的缓存生命周期
  ...
  _createClass(Keeper, [{
    ...
    value: function componentWillUnmount() {
      var _this$props4 = this.props,
          ...
          id = _this$props4.id; // 卸载前尝试归位 DOM 节点
    ...
    value: function value() {
      clearTimeout(this.freezeTimeout); // 激活后，立即解冻
...
var KeepAlive = /*#__PURE__*/function (_Component) {
  ...
  function KeepAlive(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "init", function () {
      var _this$props3 = _this.props,
          ...
          rest = _objectWithoutProperties(_this$props3, _excluded$5); // 将 children 渲染至 AliveScopeProvider 中
  ...
  _createClass(KeepAlive, [{
    key: "shouldComponentUpdate",
    value: // 利用 shouldComponentUpdate 提前触发组件更新
